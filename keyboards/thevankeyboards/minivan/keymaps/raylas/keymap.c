...
#define LS_ESC  LT(KC_LSFT, KC_ESC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT_arrow( /* Qwerty */
    ...
    LS_ESC,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_SLSH,
  ...
  [_L1] = LAYOUT_arrow( /* LAYER 1 */
    ...
    _______, KC_ESC,  BL_TOGG, KC_PSCR, _______, _______, _______, _______, _______, KC_MPLY, KC_VOLU, _______,
